...
COURSE_ID = 149381
PROGRAMMING_ASSIGNMENT_ID = {{replace:prog_id}}
FRQ_ASSIGNMENT_ID = {{replace:frq_id}} # only for HW's, comment out for labs
FRQ_Q_NUMS = {{replace:frq_nums}} # questions to be exported as FRQ (only for HW's)
...
if __name__ == '__main__':
    ...
    print("\nImportant: Please log into Gradescope and confirm that the entirety of your completed assignment is there.")
    print("It may take a few minutes for Gradescope to display your submission.\n\n")
    print("View your submissions here:\n")
    if FRQ_ASSIGNMENT_ID is not None:
        print("FRQ submission:")
        print("https://www.gradescope.com/courses/" + str(COURSE_ID) + "/assignments/" + str(FRQ_ASSIGNMENT_ID))
    if PROGRAMMING_ASSIGNMENT_ID is not None:
        print("\nProgramming submission:")
        print("https://www.gradescope.com/courses/" + str(COURSE_ID) + "/assignments/" + str(PROGRAMMING_ASSIGNMENT_ID))

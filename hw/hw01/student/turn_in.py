...
ASSIGNMENT_RMD_PATH = "hw01.Rmd"
COURSE_ID = 149381
PROGRAMMING_ASSIGNMENT_ID = 871795
FRQ_ASSIGNMENT_ID = 871793 # only for HW's, comment out for labs
FRQ_Q_NUMS = [5] # questions to be exported as FRQ (only for HW's)
